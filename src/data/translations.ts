export const translations = {
  TL: {
    navbar: {
      links: [
        { name: 'Home', href: '#home' },
        { name: 'Ano ang Vasectomy?', href: '#whatis' },
        { name: 'Myths vs Facts', href: '#myths' },
        { name: 'Mga Benepisyo', href: '#benefits' },
        { name: 'FAQ', href: '#faq' },
    ...
    benefits: {
      title: 'Mga Benepisyo ng Vasectomy',
      items: [
        {
    ...
    research: {
      ...
      subtitle: 'Ang vasectomy ay sinusuportahan ng maraming pag-aaral mula sa buong mundo.',
      stats: [
        { value: '99.9%', label: 'Effectivity Rate' },
        { value: '98%', label: 'Satisfaction ng mga Lalaki' },
    ...
    contact: {
      ...
      messagePlaceholder: 'Ano ang iyong katanungan?',
      sendBtn: 'Ipadala',
      successTitle: 'Naipadala na!',
  ...
  EN: {
    navbar: {
      links: [
        { name: 'Home', href: '#home' },
        { name: 'What is Vasectomy?', href: '#whatis' },
        { name: 'Myths vs Facts', href: '#myths' },
    ...
    research: {
      title: 'Research & Data',
      subtitle: 'Vasectomy is supported by numerous studies worldwide.',
      stats: [
        { value: '99.9%', label: 'Effectivity Rate' },
        { value: '98%', label: 'Male Satisfaction Rate' },
    ...
    contact: {
      ...
      messagePlaceholder: 'What is your question?',
